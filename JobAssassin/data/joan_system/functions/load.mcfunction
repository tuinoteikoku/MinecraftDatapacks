...
### スキルのCT用スコアボード
scoreboard objectives add joan_normal minecraft.dropped:minecraft.copper_ingot
scoreboard objectives add joan_active minecraft.dropped:minecraft.iron_ingot
