...
effect give @s[scores={joan_active=1}] regeneration 5 2 true
...
effect give @s[scores={joan_special=1}] resistance 15 2 true
effect give @s[scores={joan_special=1}] saturation 15 2 true
