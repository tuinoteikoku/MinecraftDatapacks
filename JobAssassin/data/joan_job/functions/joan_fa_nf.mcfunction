execute at @a[tag=joan_fa,scores={joan_fa_n=1..},y_rotation=-45..45] at @p if block ~ ~ ~3 minecraft:air run tp @a@a[tag=joan_fa,scores={joan_fa_n=1..},y_rotation=-45..45] ~ ~ ~3
