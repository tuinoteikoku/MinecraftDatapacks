# 範囲収縮地点決定
execute in ja-world at @e[tag=joan_safe,limit=1] run spreadplayers ~ ~ 0 20.0625 under 300 false @e[tag=joan_safe,limit=1]
...
# 範囲収縮中心予告
tellraw @a [{"text":"第三範囲収縮の中心は X:"},{"nbt":"PosX","storage":"area_pos"},{"text":" , Z:"},{"nbt":"PosZ","storage":"area_pos"},{"text":"です。"}]
