...
## アクティブアビリティ効果
execute at @a[tag=joan_wo,scores={joan_active=1,joan_ab_a=0}] as @a[tag=joan_play,distance=1..30] run effect give @s minecraft:glowing 10 1 true
execute at @a[tag=joan_wo,scores={joan_active=1,joan_ab_a=0}] as @a[tag=joan_play,distance=1..30] run effect give @s minecraft:slowness 10 1 true
execute at @a[tag=joan_wo,scores={joan_active=1,joan_ab_a=0}] as @a[tag=joan_play,distance=1..30] run effect give @s minecraft:blindness 10 1 true
