...
execute at @a[tag=joan_er,scores={joan_active=0,joan_ab_a=800..1000}] as @a[tag=joan_play,distance=1..25,gamemode=adventure] run effect give @s minecraft:slowness 5 3 true
execute at @a[tag=joan_er,scores={joan_active=0,joan_ab_a=800..1000}] as @a[tag=joan_play,distance=1..25,gamemode=adventure] run effect give @s minecraft:blindness 5 1 true
...
## ノーマルアイテム
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_n=0}] hotbar.6 with minecraft:iron_ingot{display:{Name:'"食中毒"',Lore:['[{"text":"Qキーで使用"}]','[{"text":"半径十数ブロック内に視覚異常を与える"}]','[{"text":"[ノーマル]"}]']},CustomModelData:50126} 1
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_n=1..}] hotbar.6 with minecraft:raw_iron{display:{Name:'"食中毒"',Lore:['[{"text":"クールタイム中"}]','[{"text":"半径十数ブロック内に視覚異常を与える"}]','[{"text":"[ノーマル]"}]']},CustomModelData:50426} 1

## アクティブアイテム
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_a=0}] hotbar.7 with minecraft:copper_ingot{display:{Name:'"蒼穹の雲隠れ"',Lore:['[{"text":"Qキーで使用"}]','[{"text":"自身の回復と半径20ブロック程度に鈍足を付与"}]','[{"text":"[アクティブ]"}]']},CustomModelData:50226} 1
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_a=1..}] hotbar.7 with minecraft:raw_copper{display:{Name:'"蒼穹の雲隠れ"',Lore:['[{"text":"クールタイム中"}]','[{"text":"自身の回復と半径20ブロック程度に鈍足を付与"}]','[{"text":"[アクティブ]"}]']},CustomModelData:50526} 1

## スペシャルアイテム
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_s=0}] hotbar.8 with minecraft:gold_ingot{display:{Name:'"パンデミック"',Lore:['[{"text":"Qキーで使用"}]','[{"text":"半径10ブロック前後にウィザー状態を付与"}]','[{"text":"[スぺシャル]"}]']},CustomModelData:50326} 1
item replace entity @a[tag=joan_er,tag=joan_play,gamemode=adventure,scores={joan_ab_s=1..}] hotbar.8 with minecraft:raw_gold{display:{Name:'"パンデミック"',Lore:['[{"text":"クールタイム中"}]','[{"text":"半径10ブロック前後にウィザー状態を付与"}]','[{"text":"[スペシャル]"}]']},CustomModelData:50626} 1

## パッシブアイテム&その他
item replace entity @a[tag=joan_er,tag=joan_play] inventory.8 with minecraft:netherite_ingot{display:{Name:'"ストーキング"',Lore:['[{"text":"使用不可"}]','[{"text":"スニークで透明化ただし時間制限アリ"}]','[{"text":"[パッシブ]"}]']},CustomModelData:50026} 1